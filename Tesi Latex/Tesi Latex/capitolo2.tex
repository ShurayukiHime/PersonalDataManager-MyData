...
Ancora in via di sviluppo, si basa sul concetto di modularit\`a che punta a fare di ogni servizio un modulo separato e indipendente. In questo modo si applica efficacemente il principio di suddivisione delle responsabilit\`a e migliora la manutenibilit\`a sia del sistema nel complesso che dei singoli servizi.
