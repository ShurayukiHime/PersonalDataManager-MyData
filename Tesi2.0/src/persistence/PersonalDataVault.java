...
public class PersonalDataVault implements IPersonalDataVault {
	...
	public PersonalDataVault() {
		this.serviceUsers = new HashSet<>();
	}

	//questi metodi andrebbero tutti modificati indicando di quale utente si vogliono le preferenze
	//e quali preferenze si richiedono (individuazione di un dataset)
	//quindi se va tutto bene fanno la richiesta all'utente specifico per i dati specifici
	//come fare a capire che si stanno richiedendo troppi dati?
	
	//ci sono quindi delle funzioni in più che si occupano di verificare la legittimità delle richieste
	//dovrei pensare a dei codici di risposta (tutto ok, non autorizzato...)?
	...
	private class ServiceUser extends MyDataUser {
